...
powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/samdivaio/NadekoBot-Extensions/master/no_owner_log/LogCommands.cs -OutFile '%FILENAME%'"
GOTO end
:end
